...
public class Demo1 {
    ...
    private static void tableRows(StringBuffer buf) {
        ...
        for (String key : stringSet) {
            ...
            //  获取到某一个 key的 所有图层
            buf.append("<tr><td style=\"min-width: 100px;\"><strong id=\"typeContent")
            ...
            for (TC_ArcGISCacheLayer tc_arcGISCacheLayer : tc_arcGISCacheLayers) {
                String desort = tc_arcGISCacheLayer.getSortkey() + "_";
                keyList.add(desort);
            ...
            if (keyList.size() >= 6) {
                ...
                // 选择框
                // 所有排列组合
                List<String> collect = permutationNoRepeat(keyList, keyList.size());
                buf.append(" <td style=\"min-width: 100px;\"><select id=\"selectChange")
                        .append(String.valueOf(sum))
                        .append("\">");
                ...
                // 图层名称
                layername =
                        key + ":" + collect.get(0).substring(0, collect.get(0).lastIndexOf("_"));

                buf.append(" <td style=\"min-width: 100px;\"><strong class=\"")
                        .append("showName")
                        .append(String.valueOf(sum))
                        .append("\">");
                buf.append(layername);
                buf.append("</strong><br /></td>");
            }
            // 图层类型
            buf.append("<td style=\"min-width: 100px;\">")
            ...
            buf.append("<td><a id=\"yuanshuju")
                    .append(String.valueOf(sum))
                    .append("\" href=\"group/")
                    .append(layername)
                    .append("/wmts?REQUEST=getcapabilities \">元数据</a></td>");
            // 切片方案集
            buf.append("<td style=\"min-width: 100px;\">")
            ...
            // openlayer
            buf.append("<td id=\"centers").append(String.valueOf(sum)).append("\">打开图层: [");
            for (int i1 = 0; i1 < gridSubsets.size(); i1++) {
            ...
            //            buf.append("<script>\n");
            //            buf.append("var typeContent")
            //                    .append(String.valueOf(sum))
            //                    .append("= document.getElementById('typeContent")
            //                    .append(String.valueOf(sum))
            //                    .append("')\n");
            //            buf.append("var showName")
            //                    .append(String.valueOf(sum))
            //                    .append("= document.querySelector('.showName")
            //                    .append(String.valueOf(sum))
            //                    .append("')\n");
            //            buf.append("var yuanshuju")
            //                    .append(String.valueOf(sum))
            //                    .append("= document.getElementById('yuanshuju")
            //                    .append(String.valueOf(sum))
            //                    .append("')\n");
            //            buf.append("var centers")
            //                    .append(String.valueOf(sum))
            //                    .append("= document.getElementById('centers")
            //                    .append(String.valueOf(sum))
            //                    .append("')\n");
            //            buf.append("selectChange")
            //                    .append(String.valueOf(sum))
            ...
            //                buf.append("showName")
            //                        .append(String.valueOf(sum))
            //                        .append(".innerHTML = typeContent")
            //                        .append(String.valueOf(sum))
            //                        .append(".innerText + ':' + selectChange")
            //                        .append(String.valueOf(sum))
            //                        .append(".value\n");
            //                buf.append("yuanshuju")
            //                        .append(String.valueOf(sum))
            //                        .append(".href = 'group/' + typeContent")
            //                        .append(String.valueOf(sum))
            //                        .append(".innerText + ':' + selectChange")
            //                        .append(String.valueOf(sum))
            //                        .append(".value + '/wmts?REQUEST=getcapabilities'\n");
            //                buf.append(" centers").append(String.valueOf(sum)).append(".innerHTML
            // = `打开图层: [");
            //                for (int i1 = 0; i1 < gridSubsets.size(); i1++) {
            //                    GridSubset gridSubset1 = gridSubsets.get(i1);
            //                    buf.append("<a href=\"geoair/demo?layer=")
            //                            .append("${typeContent")
            //                            .append(String.valueOf(sum))
            //                            .append(".innerText}:${selectChange")
            //                            .append(String.valueOf(sum))
            ...
            //                            String.format(
            //
            // "&format=%s&subset=%s&baselayer=%s\">%s</a>",
            //                                            "image/png",
            //                                            gridSubset1.getName(),
            //                                            layerNamel.get(gridSubset1),
            //                                            "中心点" + i1)
            //                                    + " ");
            //                }
            //                buf.append("]`");
