 ...
 */
@Data
@GaModel(text = "修改图层信息表")
public class LayerInfoUpdateVo {
...
private String theGeom;
    ...
    public static LayerInfoUpdateVo empty() {
        return new LayerInfoUpdateVo();
    }

    public LayerInfoUpdateVo copy() {
            LayerInfoUpdateVo copy = new LayerInfoUpdateVo();
